...
public class Instructions {
    GamePanel gp;
    public int subState = 0; // Current page index
    ...
    public void draw(Graphics2D g2) {
        // --- 1. THEME BACKGROUND ---
        // Using the Light Grey from your specs [cite: 119]
        g2.setColor(new Color(211, 211, 211)); 
        g2.fillRect(0, 0, gp.screenWidth, gp.screenHeight);

        // --- 2. CONTENT LOGIC ---
        g2.setColor(Color.BLACK); // Body text colour [cite: 119]

        switch (subState) {
            case 0: drawCenteredPage(g2, "Campus Crisis – Player Guide 🏛️", "Welcome to the presidency! Let's learn the ropes."); break;
            case 1: drawCenteredPage(g2, "Welcome to Campus Crisis! ✨", "You are the Student President, and it’s your job to keep students happy while managing the school budget. 💰 \n\nMake smart choices — every decision matters!"); break;
            case 2: drawLeftAlignedPage(g2, "Getting Started 🚀", "• Log in using your username and password. 🔑\n• Enter your President name. ✍️\n• You’ll be taken to the main dashboard where your term begins. 🏁"); break;
            case 3: drawLeftAlignedPage(g2, "Dashboard 📊", "On the dashboard you can see:\n\n• President Name – Your name. 😎\n• Time – How much time you have left. ⏱️\n• Budget – Your remaining money. 💸\n• Approval – How happy the students are. 😊\n\nControls:\nPress [1] – View requests | Press [2] – History | Press [ESC] – Back"); break;
